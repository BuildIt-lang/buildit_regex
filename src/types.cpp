...
dyn_var<void(set_t<int>, int)> set_t_insert(builder::as_global("regex_runtime::set_insert"));
dyn_var<map_t<int, set_t<int>>(map_t<int, set_t<int>>, int, set_t<int>)> map_t_update(builder::as_global("regex_runtime::update_map"));
